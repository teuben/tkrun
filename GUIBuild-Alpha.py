  ...
  def tkrun(self):                                                              # Function to Create GUI
     ...
     for a in range(self._fun.func_code.co_argcount):
        ...
        if self.FieldlistOrder[a] == "ENTRY":                                         # Make Entry Class if quoted in Docstring for current Variable
           ...
           InFileSTR = InFileSTR + "PyRun.GetFile%d = GetFile%d\n" %(a,a)
           ...
           InFilesSTR = InFilesSTR + "PyRun.GetFiles%d = GetFiles%d\n" %(a,a)
           ...
           OutFileStr = OutFileStr + "PyRun.SaveFile%d = SaveFile%d\n" %(a,a)
           ...
           DirFileSTR = DirFileSTR + "PyRun.GetDir%d = GetDir%d\n" %(a,a)
